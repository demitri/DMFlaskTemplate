...
def genomes():
    ...
    add_link(ref, 'Species table','https://ensembl.sorghumbase.org/species.html')
    add_link(ref, '--Browser Links--','none')
    add_link(ref, 'PI 564163 - BTx623', 'https://ensembl.sorghumbase.org/Sorghum_bicolor')
    add_link(ref, 'PI 651496 - Rio', 'https://ensembl.sorghumbase.org/Sorghum_rio')
    add_link(ref, 'PI 655996 - Tx430', 'https://ensembl.sorghumbase.org/Sorghum_tx430nano')
    add_link(ref, 'PI 561071 - Tx436', 'https://ensembl.sorghumbase.org/Sorghum_tx436pac')
    add_link(ref, 'PI 656001 - Tx2783', 'https://ensembl.sorghumbase.org/Sorghum_tx2783pac')
    add_link(ref, 'IS12661', 'https://ensembl.sorghumbase.org/Sorghum_is12661')
    add_link(ref, 'IS3614-3', 'https://ensembl.sorghumbase.org/Sorghum_is36143')
    add_link(ref, 'IS38525', 'https://ensembl.sorghumbase.org/Sorghum_is38525')
    add_link(ref, 'IS929', 'https://ensembl.sorghumbase.org/Sorghum_is929')
    add_link(ref, 'Ji2731', 'https://ensembl.sorghumbase.org/Sorghum_ji2731')
    add_link(ref, 'R931945-2-2', 'https://ensembl.sorghumbase.org/Sorghum_r93194522')
    add_link(ref, 'IS19953', 'https://ensembl.sorghumbase.org/Sorghum_is19953')
    add_link(ref, 'PI525695', 'https://ensembl.sorghumbase.org/Sorghum_pi525695')
    add_link(ref, 'PI532566', 'https://ensembl.sorghumbase.org/Sorghum_pi532566')
    add_link(ref, 'AusTRCF317961', 'https://ensembl.sorghumbase.org/Sorghum_austrcf317961')
    add_link(ref, '353', 'https://ensembl.sorghumbase.org/Sorghum_is12661')
    add_link(ref, 'PI36008', 'https://ensembl.sorghumbase.org/Sorghum_pi536008')
    add_link(ref, 'S369-1', 'https://ensembl.sorghumbase.org/Sorghum_s3691')
#     add_link(ref, '', '')
