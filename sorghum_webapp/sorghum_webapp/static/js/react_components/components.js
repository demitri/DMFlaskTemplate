...
var _notebook = __webpack_require__(15);
...
var showAddNewButton = function showAddNewButton(element, url) {
	_reactDom2.default.render(_react2.default.createElement(_notebook2.default, { url: url }), element);
};
...
var AddNewCell = function (_React$Component) {
	_inherits(AddNewCell, _React$Component);

	function AddNewCell(props) {
		_classCallCheck(this, AddNewCell);

		//
		// constructor function
		// anything passed into object constructor is captured into "props"
		//
		return _possibleConstructorReturn(this, (AddNewCell.__proto__ || Object.getPrototypeOf(AddNewCell)).call(this, props));
		// can define state variables as needed	
	}

	_createClass(AddNewCell, [{
		key: "render",
		value: function render() {
			...
			return _react2.default.createElement(
				"a",
				{ className: "add-circle", href: this.props.url },
				"Add New Cell"
			);
		}
	}]);
